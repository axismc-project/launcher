...
const Settings: React.FC = () => {
  ...
  return (
    <div className="h-full flex bg-transparent">
      ...
      {/* Contenu principal avec scroll fixe */}
  ...
  >
    <div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Profil principal */}
        <div className="glass-card-dark p-6 rounded-xl interactive-glow">
          ...
          <div className="flex items-center gap-6 mb-6">
            <div className="relative">
              <img 
                ...
                alt="Avatar" 
                className="w-20 h-20 rounded-xl border-2 border-green-500/30"
              />
              <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-green-500 rounded-full border-2 border-gray-900 glow-effect"></div>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex justify-between text-sm text-white/40 mt-2">
                <span>1 GB</span>
                <span className="text-green-400 font-semibold">{Math.round(settings.minRam / 1024)} GB</span>
                <span>8 GB</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex justify-between text-sm text-white/40 mt-2">
                <span>2 GB</span>
                <span className="text-green-400 font-semibold">{Math.round(settings.maxRam / 1024)} GB</span>
                <span>32 GB</span>
              </div>
            </div>
          </div>
      ...
      <div className="glass-card-dark p-6 rounded-xl interactive-glow">
        ...
        <div className="flex items-center gap-6">
          <img 
            src={userProfile.profilePicture} 
            alt="Avatar" 
            className="w-16 h-16 rounded-xl border-2 border-green-500/30"
          />
          <div>
